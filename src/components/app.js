    ...
    render() {
        ...
        return (
            <div>
                <div className='text-center'>
                    <h1>Leader Board</h1>
                    <h4 className>{'Top 100 ' + this.pageTitle(this.state.currentView)}</h4>
                    <button onClick={() => this.changeView('recentCampers')} className={'btn btn-page ' + this.isActive('recentCampers')}><i className='fa fa-star-o'></i> Recent</button>
                    <button onClick={() => this.changeView('allTimeCampers')} className={'btn btn-page ' + this.isActive('allTimeCampers')}><i className='fa fa-hourglass-o'></i> All Time</button>
                </div>
